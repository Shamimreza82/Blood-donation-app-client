...
const AllUsers = () => {
    ...
    <div className="flex items-center gap-x-3">
        ...
        <span className="px-3 py-1 text-xs text-blue-800 bg-blue-100 rounded-full dark: dark:text-blue-800">{allUsers.length} users</span>
    </div>
                    ...
                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-300">
                        <thead className="bg-gray-50 ">
                            <tr>
                                ...
                                <th scope="col" className="px-4 py-3.5 text-sm font-bold text-left rtl:text-right text-gray-500 dark:text-gray-600">Email address</th>
                                <th scope="col" className="px-4 py-3.5 text-sm font-bold text-left rtl:text-right text-gray-500 dark:text-gray-600">Email address</th>
                                <th scope="col" className="relative py-3.5 px-4">
                                    <span className="text-gray-600 font-bold">Edit</span>
                                </th>
                            </tr>
                        </thead>
                        <tbody className="bg-white divide-y divide-gray-200 dark:divide-gray-300 ">
                            {
                                ...
                                <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div className="inline-flex items-center gap-x-3">
                                        ...
                                        <div className="flex items-center gap-x-2">
                                            ...
                                            <div>
                                                <h2 className="font-medium text-gray-800 dark:text-Blaxk ">{users.Name}</h2>
                                                <p className="text-sm font-normal text-gray-600 dark:text-gray-400">@{users.Name}</p>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td className=" py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div className="inline-flex items-center px-3 py-1 rounded-full gap-x-2 bg-red-100/60 ">
                                        ...
                                        <h2 className="text-sm font-normal text-red-500">{users?.role}</h2>
                                    </div>
                                </td>
                                <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-900 whitespace-nowrap">{users.email}</td>
